...
- Author design docs at `docs/design/<subject>/README.md` (relative to current workspace folder); they are the only planning artefact.
- Register every design doc in `docs/design/QUEUE.md` (relative to current workspace folder) as a checkbox entry ordered from ready-to-pull to most constrained.
...
## Work Coordination
- Treat `docs/design/QUEUE.md` (relative to current workspace folder) as the single dependency-ordered reservation surface.
...
- Step 3 — After hand-off or completion,
    ...
    3.2 Move this design doc into `.archive/` (relative to current workspace folder).
