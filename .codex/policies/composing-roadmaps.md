...
- If a new change requires touching a file already owned by another item, decompose by splitting/refactoring first, then update roadmap items so ownership stays disjoint.
